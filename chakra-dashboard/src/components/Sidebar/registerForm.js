 ...
 * 
 * DataManager
 *    Keeps an array of all filters (json)
 * 
 * Sidebar
 *    <Filter/>
 *        all filter data discussed
 *    Add Filter
 *      access DataManager and add Filter with id = # created
 * 
 *  Map
 *    access to data manager and applies filters and stuff
 */